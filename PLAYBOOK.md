...
- FREEZE if a retrained reference (or your β-based estimate of it) beats your frozen specialist by ≤1pp (classification) / ≤2pp (structured generation). This is the right call for most data-bound tasks — the paper found intent specialists retained 99–101% of attainable gain over 14 months.
